<?php
$sufijo = "062014";
$fecha_generacion = "05/07/2014";
$fecha_ini = "01/06/2014";
$fecha_fin = "30/06/2014";
$replace = "/06/";
$replace1 = "2014";
$eps = "ESS091";
       ...
       $fecha =  str_replace("31","30",$fecha);
        while($cont<=14){
            if($cont>0)$texto = $texto.",";
             ...
             if($cont == 0 && $eps == "EPS002")$texto =$texto.trim($sub_fila[18],' ');  
    ...
    while ($sub_fila = sqlsrv_fetch_array($stmt1, MYSQL_BOTH)) {
       ...
       $fecha =  str_replace("31","30",$fecha);
        ...
        while($cont<=16){
            ...
            if($cont>0)$texto = $texto.",";            
            if($cont == 0 && $eps == "EPS002")$texto =$texto.trim($sub_fila[20],' '); 
            else if($cont == 4) $texto = $texto.$fecha;
            else $texto = $texto.$sub_fila[''.$cont];                                                
